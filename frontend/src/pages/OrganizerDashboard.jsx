...
function OrganizerDashboard() {
  ...
  return (
    <div className="rkc-page org-page">
      {/* ---------- HERO ---------- */}
      <HudFrame className="rkc-hero org-hero" style={{ '--hud-size': '30px', '--hud-inset': '20px' }}>
        ...
        <div className="rkc-hero-inner">
          <SectionEyebrow className="rkc-hero-eyebrow">Area Organizzatori</SectionEyebrow>
          <h1 className="rkc-title">Gestione <em>Eventi</em></h1>
      ...
      <section className="rkc-section container">
        {/* ---------- NUOVO EVENTO ---------- */}
        <HudFrame className="org-panel" corners={['tl', 'br']}>
          <h2 className="org-panel-title">Nuovo Evento</h2>

          {successMsg && <div className="org-msg is-success">{successMsg}</div>}
        ...
        {/* ---------- RISULTATI GARA ---------- */}
        <HudFrame className="org-panel" corners={['tl', 'br']}>
          <h2 className="org-panel-title">Risultati Gara</h2>

          {resultsSuccessMsg && <div className="org-msg is-success">{resultsSuccessMsg}</div>}
          {resultsErrorMsg && <div className="org-msg is-error">{resultsErrorMsg}</div>}
          ...
          <form onSubmit={handleResultsSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div className="brutalist-input-group is-dark">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {rows.map((row, idx) => (
                  <div key={idx} className="org-row-grid">
                    <input
                      type="text"
                      list="profiles-list"
